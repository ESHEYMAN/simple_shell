...
/**
 * what - Find the needed directory
...
/**
 * is_main_path - Check the order of the path
 * @path: PATH to check
 * @info: General information about the shell
 **/
...
{
	info->is_main_path = _FALSE;
	if (path == NULL)
		return;

	if (path[0] == ':')
		info->is_main_path = _TRUE;
}

/**
 * get_all_environ - Get all the environment
 *
 */
